<?php
	...
	if(isset($_GET["cveGuia"]))
	{
		$checadoSi = '';
		$checadoNo = 'checked="checked"';
	}
	else
	{
		$checadoSi = 'checked="checked"';
		$checadoNo = '';
	}
?>
        ...
        <form id="form2">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="autoGuia"></div>
 				<img id="imgInfo" src="imagenes/informacion.png" title="Informaci&oacute;n de Gu&iacute;a" onmouseover="mostrarInfo();" onmouseout="quitarInfo();"/>
                                <div id="divInfoGuia">
                                    <table>
                                        <tr>
                                            <td align="right">FOLIO:</td>
                                            <td align="left" id="tdNoFolio"></td>
                                        </tr>
                                        <tr>
                                            <td align="right">FACTURA:</td>
                                            <td align="left" id="tdNoFac"></td>
                                        </tr>                                    
                                    </table>
                                </div>
                            </td>
                  ...
                  <legend>Datos del env&iacute;o &Aacute;ereo</legend>	
                    <table width="476">
                        ...
                        <tr>
							...
							<td>Costo Gu&iacute;a &Aacute;erea </td>
                            <td>
                            	<input id = "txtCtoGuiaAerea" name= "txtCtoGuiaAerea" type="text" size="15"  tabindex="7" onkeydown="return chk_val(this.id,event);"/>
                            </td>
                        </tr>
                        <tr>	
                ...
                <fieldset id="derecho2" class="flddestinatario">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Estado</td>
                            <td>
                                <select name="txtEstadoD" id="txtEstadoD" tabindex="23">
									<?php $opciones = $bd->get_select('cestados','cveEstado','nombre',0,''); echo $opciones; ?>
								</select>
                            </td>											
                            <td>Municipio / Delegaci&oacute;n</td>
            ...
            <div>
                <div class="observaciones">
                    <fieldset class="fldobservaciones" style="width:600px;">
                        <legend>Observaciones</legend>
                        <textarea name="txaObservaciones" id="txaObservaciones"  rows="4" cols="70" tabindex="45"><?php echo $observacion; ?></textarea>
                    </fieldset>
                </div>
                ...
                <div class="controlesBtnImp">
                    <fieldset>
                        <legend>Impresi&oacute;n</legend>
                        <table>
                            <tr>
                                <td>	                        
                                    <div>	
                                  ...
                                  Imprimir Folio de Gu&iacute;a:<br />
                                    <input type="radio" name="rdbImprimir" id="rdbImprimirSi" <?php echo $checadoSi;?> >Si</input>
                                    <input type="radio" name="rdbImprimir" id="rdbImprimirNo" <?php echo $checadoNo;?> >No</input>
									<input type="button" name="btnImprimir" id="btnImprimir" value= "Imprimir" tabindex="49" onclick="imprimirGuia();"/>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                </div>
                <div class="observacionesCliente">
                    <fieldset class="fldobservacionesCliente" style="width:600px;">
                        ...
                        <table border="0">
                        	<tr>
                            	<td>
                        <!--slcDiceContener-->
                        <input type="radio" name="rdbContenido" id="rdbNuevo" value="N" onchange="chkControles('N');" />Nuevo Registro
                        <input type="radio" name="rdbContenido" id="rdbOtro" value="O" onchange="chkControles('O');" />Otro
						<input name="txthContenido" type="hidden" id="txthContenido"/>                        
						<input name="txtContenido" type="text" id="txtContenido"/>
                        <div id="autoContenido"></div>
                        <div id="divCheck" style="position:absolute; margin-top:-23px; margin-left:330px; visibility:hidden;">
                        <input type="checkbox" id="ckbEditar" name="ckbEditar" onclick="edicionDiceContener();" />Editar</div>
	                            </td>
                            </tr>
                            <tr id="trTitulo" style="visibility:hidden;">
                            	<td>
                                	<input type="hidden" id="hddUsuario" name="hddUsuario" value="<?php echo $usuario;?>" />
                                	Titulo:
                                	<input type="text" id="txtTitulo" name="txtTitulo" size="50" />
                                    <input type="button" id="btnGuarcarContenido" name="btnGuarcarContenido" value="Guardar Nuevo" onclick="guardarDiceContener();" />
                                </td>
                            </tr>
                            <tr>
                            	<td>Dice Contener
                        <textarea id="txtDContener" name="txtDContener" readonly="readonly" cols="71" rows="2" onkeydown="validarTamanio(this,100);" onkeyup="validarTamanio(this,100);" /></textarea>
                        <!--<textarea id="txtDContener" name="txtDContener" cols="71" rows="2" onkeydown="validarTamanio(this,100);" onkeyup="validarTamanio(this,100);" /></textarea>-->
                                </td>
                            </tr>
                            <tr>
                            	<td>
                        Observaciones
                        <br />
                        <textarea name="txaObservacionesC" id="txaObservacionesC" cols="71" rows="4" onkeydown="validarTamanio(this,200);" onkeyup="validarTamanio(this,200);" tabindex="45"></textarea>
                                </td>
                            </tr>
                        </table>
                    </fieldset>

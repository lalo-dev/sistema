  ...
  <div id="contenedor">
        <div id="encabezado">
          <table width="950" border="0">
            <tbody>
              <tr>
                <td width="468" height="85"><img id="logotipo" src="imagenes/e-webfac.jpg" alt="e-webfac" height="68" width="136"/></td>
                <td width="466"><a href="http://www.cargayexpress.com.mx"><img src="imagenes/inicio.jpg" alt="" width="83" height="83" align="right"/></a></td>
              </tr>
            </tbody>
          </table>
          <p><img id="cabecera" src="imagenes/Cabecera.jpg" alt="cabecera" height="15" width="950"/></p>
    </div>
     <div id='cuerpo'>

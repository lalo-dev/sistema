...
<script type="text/javascript" src="scripts/ajaxOperaciones.js"></script>
...
?>
            <div id="derecho">
                <div class="cabecera">
                    <div id="ruta">Reportes | Operaciones</div>
                    <h2 id="titulo">Operaciones</h2>
                </div>
		<br/>
  		<form id="form2">
			<div class="izquierda">
			...
			<div id="pnlDatosGenerales">
				<fieldset>
					...
					<table>
						...
						<tr>
							<td><input type="button" id="btnEnviar" value="Generar Reporte" /></td>
						</tr>
					</table>        
				</fieldset>
			</div>

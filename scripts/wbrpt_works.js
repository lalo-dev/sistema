...
function consulta(){
	...
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_id = '" + $(currentFilter).value+"'";
	$("hQuery").value = query;
	return true;
	} else{return false;}
	break;
	...
	//filtro por cliente
	if($(currentFilter).value != ""){
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_cname = '" + $(currentFilter).value+"'";
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	if($(currentFilter).value != ""){
	//filtro por destino
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_destbranch = '" + $(currentFilter).value+"'";
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	case "r3":
	if($(currentFilter).value != ""){
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_consignee = '" + $(currentFilter).value+"'";
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_rcye >= '" + $(currentFilter).value+"' and wb_rcye <= '"+ $("fieldr5").value+"'";
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	case "r5":
	if($("fieldr6").value != ""){
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_status = '" + $("fieldr6").value+"'";
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	query = "select wb_id, branch_desc, airline_name, wb_flightnum, wb_airwb, wb_flightdate, wb_rcye, wb_cName, wb_cPhone, wb_cExt, wb_cRfc, wb_consignee, wb_pieces, wb_kg, wb_vol, wb_validity, wb_destbranch, wb_destzp, wb_destadd, wb_status, wb_delivdate, wb_receivedby, wb_dlvnbr wb_vlnbr, wb_invnbr, wb_receiptdate, wb_rmks from waybill_mstr inner join airline_mstr on wb_airline = airline_id inner join branch_mstr on wb_destbranch = branch_id WHERE wb_id >= " + $("fieldr7").value+" and wb_id <= "+ $("fieldr8").value;
	$("hQuery").value = query;
	return true;
	}else{return false;}
	break;
	...
	default:
	alert("No se ha definido una accion para éste filtro - Errir de la aplicacion -");
	return false;
	break;
	}

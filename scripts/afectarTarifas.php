<?php
	...
	}else if($opcion==2)
	{
		...
		if($slctipoClienteCargoMin!="" && $slctipoEnvio!="")
		{
			...
			$extra=" para el tipo de cliente ".$slctipoClienteCargoMin." y el envío ".$slctipoEnvio;
		}
		else
		{	
			...
			if($slctipoEnvio!="")
			{
				...
				$extra=" para el tipo de envío ".$slctipoEnvio;
			}
		}
	...
	echo "Error: $my_error1";
		...
		if($opcion==2 || $opcion==3) 
			echo utf8_encode("El cargo mínimo ".$extra." fue afectado con el $porcentaje% $accion.");
		else

 ...
 */
	...
	if($camposMostrar[1]==1) {$pdf->Cell(17,6,'No. Guía',1,0,'C',1); $m++; $xf=$pdf->GetX(); $med=17;}	
	
	if($camposMostrar[2]==1) {$pdf->Cell(22,6,'Factura/Remisión',1,0,'C',1); $m++; $xf=$pdf->GetX(); $med=22;}	
	...
	if($camposMostrar[6]==1) {$pdf->Cell(19,6,'Observación',1,0,'C',1); $m++; $xf=$pdf->GetX(); $med=16;}
...
//	if($camposMostrar[13]==1) {$pdf->Cell(14,6,'Seguro',1,0,'C',1); $m++; $xf=$pdf->GetX(); $med=14;}
	...
	$pdf->Cell(13,6,'Retención',1,0,'C',1);
	...
	//Definimos los anchos y la alineación del texto
	...
	if($cuantasf>0)
	{
		...
		{   
				...
				if($camposMostrar[6]==1) {$pdf->Cell(19,6,'Observación',1,0,'C',1); $m++; $xf=$pdf->GetX(); $med=17;}

	...
	if ($caracteres != ""){
		switch($operacion){
			...
			case 5://Agregada
				{
					$cliente=$_GET['cliente'];
					$dests = $bd->ExecuteFieldn("cguias", "cveGuia,nombreRemitente"," cveConsignatario=0 AND cveCliente=".$cliente." AND (cveGuia LIKE '$caracteres%%' OR nombreRemitente LIKE '$caracteres%%') LIMIT 0,5");
				}
				break;	
			case 6:
				{

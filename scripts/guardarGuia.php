<?php
	...
	$conexion = mysql_connect("localhost","root","") or die (mysql_error());	//Se cambia el nomvre de usuario y contrase�a "webcom" y "webcom" por el de "root" y "" para que funcione en mi maquina ---> por Said
